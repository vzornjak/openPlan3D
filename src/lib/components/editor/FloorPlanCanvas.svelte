  ...
  {#if (currentSelectedId || currentSelectedIds.size > 0) && currentFloor && currentTool === 'select' && !elevationOpen}
    ...
    {#if el}
      <div
        ...
        class="absolute bottom-2 left-1/2 -translate-x-1/2 max-md:bottom-[calc(var(--visible-bottom)+3rem)] z-[45] flex items-center gap-0.5 bg-white rounded-lg shadow-lg border border-gray-200 px-1 py-0.5"
      >
        <button
